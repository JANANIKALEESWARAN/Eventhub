...
const CreateEvent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setDialogConfig({ isOpen: true, type: 'alert', title: 'Error', message: error.response?.data?.message || 'Failed to create event', position: 'top', onConfirm: closeDialog });
    }
  };
    ...
    <div style={{ background: 'var(--bg-color)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ paddingTop: '100px', maxWidth: '800px' }}>
        ...
        <div className="premium-card" style={{ padding: '2.5rem' }}>
          <h1 style={{ marginBottom: '2rem', fontWeight: 800 }}>Create New Event</h1>
            ...
            >
              ...
              {coverMedia ? (
                ...
                <>
                  ...
                  <span style={{ color: '#64748b', fontWeight: 600 }}>Drag & Drop or Click to Upload Cover Media</span>
                </>
              )}
            </div>
